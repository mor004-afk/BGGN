...
ab_titer <- read_json("https://www.cmi-pb.org/api/plasma_ab_titer", simplifyVector = TRUE) 
```
...
head(ab_data)
```
>Q6 How many different Ab isotypes?
...
```
>Q8. Lets [plot antigen MF1 levels across the whole dataset]
...
Plot antigen levels again but for IgG
