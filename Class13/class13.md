...
check correspondence of `metadata` and `counts` (i.e. thata the columns
...
```
    ...
    Info: Working in directory /Users/montse/Desktop/BGGN/BGGN/Class13
...
could not attach example due to error during render: Could not convert a
SVG to a PDF for output. Please ensure that rsvg-convert is available on
the path.
